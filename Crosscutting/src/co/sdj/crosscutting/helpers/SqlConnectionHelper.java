...
public final class SqlConnectionHelper {
	...
	public static boolean connectionIsOpen(final Connection connection) {
		try {
			...
			throw new SdjApplicationException(userMessage, technicalMessage, exception, Layer.DATA);
		}
	}
	...
	public static void initTransaction(final Connection connection) {
		...
		try {
			...
			if (!connection.getAutoCommit()) {
				...
				throw new SdjApplicationException(userMessage, technicalMessage, new Exception(), Layer.DATA);
			}
