...
public final class FindIdentificationTypeFacadeImpl implements FindIdentificationTypeFacade {
	...
	public List<IdentificationTypeDTO> execute(final IdentificationTypeDTO data) {
		...
		try {
			...
			var userMessage = "Se ha presentado un problema tratando consultar la información de los tipos de identificiaciones...";
			var technicalMessage = "Se ha presentado un problema inesperado consultando la información de los tipos de identificaciones . Por favor revise el log de errores para tener más detalles...";
